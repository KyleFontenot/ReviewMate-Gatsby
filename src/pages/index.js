...
// const CascadeBlock = React.lazy(() => import("../components/CascadeBlock"))
  ...
  return (
    <Layout>
      ...
      <Block
        row="row--row"
        h2="At a glance"
        style={{ borderBottom: "2px solid #9a2a24" }}
      />
      <CascadeBlock>
        <div
      ...
      <CascadeBlock>
        ...
        <div className="column cascadeBlock__text">
          ...
          <ul>
            ...
            <li>
              Calculate accuracy rates automatically on an aggregate level, for
              each element, and by coder
            </li>
      ...
      >
        ...
        >
          Our services are manicured for your use, so connect with us for
          questions or applications. We're excited to hear from you!
        </p>
        <Link
          to="/contact"
          style={{
        ...
        >
          <button className="button button--pert">Contact us</button>
        </Link>
      </Block>
    </Layout>
  )
